			...
			<TerminalWindow title="~/connect.sh — bash">
				<div className="font-mono">
					...
					<a
						...
						onClick={() => gtagEvent('contact_email_click', { category: 'Contact', label: 'contact email', value: 'mailto:rc.ravulapati@gmail.com' })}
					>
					...
					<div className="flex flex-wrap gap-3 pt-4 border-t border-gray-200 dark:border-gray-800">
						<a
							...
							onClick={() => gtagEvent('contact_link_click', { category: 'Contact', label: 'linkedin', value: 'https://www.linkedin.com/in/ravichandrar/' })}
						>
						...
						<a
							...
							rel="noreferrer"
							className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-800 text-gray-700 dark:text-gray-300 text-xs font-mono transition-all duration-200 hover:border-accent hover:text-accent"
							onClick={() => gtagEvent('contact_link_click', { category: 'Contact', label: 'github', value: 'https://github.com/ravichandra480' })}
						>
							<svg width="14" height="14" viewBox="0 0 24 24" fill="none">
						...
						<a
							...
							rel="noreferrer"
							className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-800 text-gray-700 dark:text-gray-300 text-xs font-mono transition-all duration-200 hover:border-accent hover:text-accent"
							onClick={() => gtagEvent('contact_link_click', { category: 'Contact', label: 'npm', value: 'https://www.npmjs.com/~ravichandrar' })}
						>
							<svg width="14" height="14" viewBox="0 0 24 24" fill="none">
