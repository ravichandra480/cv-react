	...
	return (
		<main className="about">
			...
			<div>
				...
				<p className="about__job">Senior Engineer 2 at <a href="https://www.featurespace.com/" target="_blank" rel="noreferrer">Featurespace</a> <br />Senior Web Developer | Front End Architect | JavaScript | TypeScript | Angular | Elm<br /></p>
