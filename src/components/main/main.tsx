	...
	return (
		<main className="page">
			<div className="page--content">
				<ul>
					<li>Around 10 years of developing web and mobile applications using HTML5, JavaScript, JavaScript libraries (Angular, Jquery), J2EE, NodeJS.</li>
					<li>Working as Assistant Consultant with TATA Consultancy Services, Chennai, India from March 2011 to till date. Over 9 years experience in design and development of web applications using HTML5, Twitter Bootstrap, Jquery, Angular.</li>
